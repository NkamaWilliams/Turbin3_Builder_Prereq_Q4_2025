...
pub struct ThawNft<'info> {
    #[account(mut, constraint=collection_authority.creator == authority.key() @MplxcoreError::NotAuthorized)]
    pub authority: Signer<'info>,
    #[account(mut, constraint = asset.owner == &CORE_PROGRAM_ID @MplxcoreError::InvalidAsset)]
    /// CHECK This will be validated by constraint
